    ...
    <>
      <div id="topContainer">
        <div id="headerContainer">
          <span style={{ fontSize: '30px' , marginBottom:'1em', marginTop:'2em'}}> Welcome back, Guide Haruki <br /></span>
          <span style={{ fontSize: '40px' }}>  Share your rich knowledge of your local area</span>
          <div></div>
          <div>
            <div style={{ display: 'flex', flexDirection:'column', alignItems: 'center'}}>
              <span style={{ fontSize:'30px', fontWeight:'200'}}>Go To Your Profile</span>
              <img style={{width: '200px', height: '250px', objectFit:'cover', marginTop:'20px'}} src='https://images.pexels.com/photos/8329668/pexels-photo-8329668.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' alt="yuki"/>
            </div>
      ...
      <div id="Features">
        <div id="Features1" style={{ marginTop: '10em'}}>
          <h1>Feature</h1>
